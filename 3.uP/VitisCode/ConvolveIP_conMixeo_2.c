...
//Mixeo
#define rows                        42//102//302
#define columns                     42//102//452
#define orig_rows					40//100//300
#define orig_columns				40//100//450

//Dma transmission
#define NUMBER_OF_BDS_PER_PKT		1//100//113
#define NUMBER_OF_PKTS_TO_TRANSFER 	1//4
...
#define MAX_PKT_LEN_TX				0x1b90//0xA290//0x64//0x468 //0x52c
#define MAX_PKT_LEN_RX				0x1b90//0xA290//0x64//0x468
...
int main(void){
	...
	while(1){
		...
		if(!XUartLite_IsReceiveEmpty((&uart_module)->RegBaseAddress)){
				tramaFlag = GetTrama();
				Status 	  = initDMA();
