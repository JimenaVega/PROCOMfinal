...
HD_PWD='C:/PROCOM_FP/PROCOM_FP.runs/uP_axis_data_fifo_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uP_axis_data_fifo_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uP_axis_data_fifo_0_0.tcl
