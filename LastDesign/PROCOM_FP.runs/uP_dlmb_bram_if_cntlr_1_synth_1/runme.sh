...
HD_PWD='C:/PROCOM_FP/PROCOM_FP.runs/uP_dlmb_bram_if_cntlr_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uP_dlmb_bram_if_cntlr_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uP_dlmb_bram_if_cntlr_1.tcl
