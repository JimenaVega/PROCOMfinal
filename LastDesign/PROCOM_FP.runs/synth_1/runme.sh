...
HD_PWD='C:/Users/miner/Documents/JIME/4toAnio/procom/trabajo_final/PROCOMfinal/LastDesign/PROCOM_FP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uP_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uP_wrapper.tcl
