...
HD_PWD='C:/PROCOM_FP/PROCOM_FP.runs/uP_microblaze_0_axi_intc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uP_microblaze_0_axi_intc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uP_microblaze_0_axi_intc_1.tcl
