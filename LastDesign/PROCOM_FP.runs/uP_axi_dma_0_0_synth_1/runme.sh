...
HD_PWD='C:/PROCOM_FP/PROCOM_FP.runs/uP_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uP_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uP_axi_dma_0_0.tcl
