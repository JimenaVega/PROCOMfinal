...
HD_PWD='C:/PROCOM_FP/PROCOM_FP.runs/uP_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uP_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uP_clk_wiz_0_0.tcl
