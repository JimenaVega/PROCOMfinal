...
HD_PWD='C:/PROCOM_FP/PROCOM_FP.runs/uP_rst_mig_7series_0_83M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uP_rst_mig_7series_0_83M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uP_rst_mig_7series_0_83M_1.tcl
