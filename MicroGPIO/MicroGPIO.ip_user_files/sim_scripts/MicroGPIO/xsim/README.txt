...
#
# Generated by export_simulation on Sat Jul 11 13:19:42 -0300 2020
#
################################################################################
...
'-reset_run' switch to the './MicroGPIO.sh' script.

./MicroGPIO.sh -reset_run
...
./MicroGPIO.sh -noclean_files

For more information on the script, please type './MicroGPIO.sh -help'.
